...
public enum ClientCertificateType {
  ...
  static ClientCertificateType forValue(byte value) throws InvalidValue {
    switch(value) {
      case 1: return RSASign;
      case 2: return DSSSign;
      case 3: return RSAFixedDH;
      case 4: return DSSFixedDH;
      case 5: return RSAEphemeralDHRESERVED;
      case 6: return DSSEphemeralDHRESERVED;
      case 20: return FortezzaDMSRESERVED;
      case 64: return ECDSASign;
      case 65: return RSAFixedECDH;
      case 66: return ECDSAFixedECDH;
      default:

...
public class SSLSocketProxy extends AbstractSSLSocketProxy {
    ...
    public SSLSocketProxy(SSLSocket socket, InputObserver inputObserver, OutputObserver outputObserver, ExceptionObserver exceptionObserver) {
        super(socket);
